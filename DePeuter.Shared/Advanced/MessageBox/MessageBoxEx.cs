...
namespace GeoIT_Infrastructure.Advanced.MessageBox
{
	...
	public class MessageBoxEx
	{
        ...
        public static MessageBoxExButtons Show(string text, string caption, MessageBoxExIcon icon, params MessageBoxExButtons[] buttons)
	    {
	        ...
	        msgBox.Icon = icon;
            return msgBox.Show().ToEnum<MessageBoxExButtons>();
	    }

        public static string Show(string text, string caption, MessageBoxExIcon icon, params MessageBoxExButton[] buttons)
        {
            var msgBox = new MessageBoxEx();
            msgBox.Text = text;
            msgBox.Caption = caption;
        ...
        public static MessageBoxExButtons Show(string text, string caption, params MessageBoxExButtons[] buttons)
        {
            var msgBox = new MessageBoxEx();
            msgBox.Text = text;
            msgBox.Caption = caption;
        ...
        public static string Show(string text, string caption, params MessageBoxExButton[] buttons)
        {
            var msgBox = new MessageBoxEx();
            msgBox.Text = text;
            msgBox.Caption = caption;
