	...
	public class MessageBoxExManager
	{
        ...
        static MessageBoxExManager()
        {
            try
            {
                ...
                _standardButtonsText[MessageBoxExButtons.NoAll.ToString()] = rm.GetString("NoAll");
                _standardButtonsText[MessageBoxExButtons.YesAll.ToString()] = rm.GetString("YesAll");
            }
            catch(Exception ex)
            {
                ...
                _standardButtonsText[MessageBoxExButtons.NoAll.ToString()] = "No to all";
                _standardButtonsText[MessageBoxExButtons.YesAll.ToString()] = "Yes to all";
            }
        }
        #endregion
